...
class CloudSpaceShaderLoader :	public ZzShaderLoader
{
public:
	CloudSpaceShaderLoader(GLuint AtmoShader);
	~CloudSpaceShaderLoader();
...
private:
	...
	//variables
	const GLchar* filepath_cs = "Resources/Shaders/Clouds/CloudsSpace.Compute";
