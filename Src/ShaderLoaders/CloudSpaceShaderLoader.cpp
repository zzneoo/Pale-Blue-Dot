...
CloudSpaceShaderLoader::CloudSpaceShaderLoader(GLuint AtmoShader)
{
...
CloudSpaceShaderLoader::~CloudSpaceShaderLoader()
{

}
//Samplers

void CloudSpaceShaderLoader::LoadSampler3D_PerlinWorleyUniform(GLenum TEXTURE, GLuint tNo, GLuint textureID)
{
	UniformLoadTexture3D(Sampler3D_PerlinWorley3DUniform, TEXTURE, tNo, textureID);
}
void CloudSpaceShaderLoader::LoadSampler3D_Worley32Uniform(GLenum TEXTURE, GLuint tNo, GLuint textureID)
{
	UniformLoadTexture3D(Sampler3D_Worley32Uniform, TEXTURE, tNo, textureID);
}
void CloudSpaceShaderLoader::LoadSampler2D_WeatherMapUniform(GLenum TEXTURE, GLuint tNo, GLuint textureID)
{
	UniformLoadTexture2D(Sampler2D_WeatherMapUniform, TEXTURE, tNo, textureID);
}

void CloudSpaceShaderLoader::LoadSampler2D_BlueNoiseUniform(GLenum TEXTURE, GLuint tNo, GLuint textureID)
{
	UniformLoadTexture2D(Sampler2D_BlueNoiseUniform, TEXTURE, tNo, textureID);
}

void CloudSpaceShaderLoader::LoadSampler2D_CurlNoiseUniform(GLenum TEXTURE, GLuint tNo, GLuint textureID)
{
	UniformLoadTexture2D(Sampler2D_CurlNoiseUniform, TEXTURE, tNo, textureID);
}

void CloudSpaceShaderLoader::LoadSampler2D_BeerShadowMapUniform(GLenum TEXTURE, GLuint tNo, GLuint textureID)
{
	UniformLoadTexture2D(Sampler2D_BeerShadowMapUniform, TEXTURE, tNo, textureID);
}

//stock
void CloudSpaceShaderLoader::LoadSampler2D_CirrusCloudUniform(GLenum TEXTURE, GLuint tNo, GLuint textureID)
{
	UniformLoadTexture2D(Sampler2D_CirrusCloudUniform, TEXTURE, tNo, textureID);
}
void CloudSpaceShaderLoader::LoadSampler2D_CirroStratusCloudUniform(GLenum TEXTURE, GLuint tNo, GLuint textureID)
{
	UniformLoadTexture2D(Sampler2D_CirroStratusCloudUniform, TEXTURE, tNo, textureID);
}
void CloudSpaceShaderLoader::LoadSampler2D_CirroCumulusCloudUniform(GLenum TEXTURE, GLuint tNo, GLuint textureID)
{
...
void CloudSpaceShaderLoader::Loadm4InvViewX_Uniform(vmath::mat4 InvViewMatrix)
{
	UniformLoadMatrix(m4InvViewX_Uniform, InvViewMatrix);
}

void CloudSpaceShaderLoader::Loadm4LightViewProjX_Uniform(vmath::mat4 LightViewProjMatrix)
{
	UniformLoadMatrix(m4LightViewProjX_Uniform, LightViewProjMatrix);
}

void CloudSpaceShaderLoader::Loadm4PrevViewX_Uniform(vmath::mat4 PrevViewMatrix)
{
	UniformLoadMatrix(m4PrevViewX_Uniform, PrevViewMatrix);
}

void CloudSpaceShaderLoader::Loadm4ProjX_Uniform(vmath::mat4 ProjMatrix)
{
	UniformLoadMatrix(m4ProjX_Uniform, ProjMatrix);
}

void CloudSpaceShaderLoader::Loadm4InvProjX_Uniform(vmath::mat4 InvProjMatrix)
{
...
void CloudSpaceShaderLoader::LoadfTime_Uniform(GLfloat fTime)
{
	UniformLoad1f(fTime_Uniform, fTime);
}

void CloudSpaceShaderLoader::LoadfCloudFactor_Uniform(GLfloat fCloudScale)
{
	UniformLoad1f(fCloudFactor_Uniform, fCloudScale);
}
void CloudSpaceShaderLoader::LoadfEarthRadius_Uniform(GLfloat EarthRadius)
{
	UniformLoad1f(fEarthRadius_Uniform, EarthRadius);
}
void CloudSpaceShaderLoader::LoadfCloudVolumetricCoverage_Uniform(GLfloat fCloudVolumetricCoverage)
{
	UniformLoad1f(fCloudVolumetricCoverage_Uniform, fCloudVolumetricCoverage);
}

void CloudSpaceShaderLoader::LoadfCloudHighAltitudeCoverage_Uniform(GLfloat fCloudHighAltitudeCoverage)
{
	UniformLoad1f(fCloudHighAltitudeCoverage_Uniform, fCloudHighAltitudeCoverage);
}
////////////////////////////////////////////////////////Vec3/////////////////////////////////////////////////////////////////////
void CloudSpaceShaderLoader::Loadv3CameraPos_Uniform(vmath::vec3 CameraPos)
{
	UniformLoadVec3(v3CameraPos_Uniform, CameraPos);
}
void CloudSpaceShaderLoader::Loadv3SunPos_Uniform(vmath::vec3 SunPos)
{
	UniformLoadVec3(v3SunPos_Uniform, SunPos);
}

void CloudSpaceShaderLoader::Loadv3SunColor_Uniform(vmath::vec3 SunColor)
{
	UniformLoadVec3(v3SunColor_Uniform, SunColor);
}

void CloudSpaceShaderLoader::Loadv2InnerOuterRadius_Uniform(vmath::vec2 InnerOuterRadius)
{
	UniformLoadVec2(v2InnerOuterRadius_Uniform, InnerOuterRadius);
}

void CloudSpaceShaderLoader::Loadv2Resolution_Uniform(vmath::vec2 Resolution)
{
	UniformLoadVec2(v2Resolution_Uniform, Resolution);
}

void CloudSpaceShaderLoader::LoadiPixelID_Uniform(GLint PixelID)
{
	UniformLoad1i(iPixelID_Uniform, PixelID);
}

void CloudSpaceShaderLoader::LoadiFrameID_Uniform(GLuint iFrameID)
{
	UniformLoad1ui(iFrameID_Uniform, iFrameID);
}

bool CloudSpaceShaderLoader::Initialize(void)
{
...
void CloudSpaceShaderLoader::GetAllUniformLocations(void)
{
...
void CloudSpaceShaderLoader::SetAtmosphereShaderObject(GLuint AtmoshpereShaderID)
{
