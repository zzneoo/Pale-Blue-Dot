...
class CloudShadowMapShaderLoader :	public ZzShaderLoader
{
public:
	CloudShadowMapShaderLoader();
	~CloudShadowMapShaderLoader();
...
//	void LoadSampler2D_CirroCumulusCloudUniform(GLenum TEXTURE, GLuint tNo, GLuint textureID);
	...
	void LoadfShadowFactor_Uniform(GLfloat fFactor);
...
private:
	...
	//variables
	const GLchar* filepath_cs = "Resources/Shaders/Clouds/CloudShadowMap.Compute";
