...
RainParticleSystemShaderLoader::RainParticleSystemShaderLoader()
{
...
bool RainParticleSystemShaderLoader::Initialize(void)
{
...
void RainParticleSystemShaderLoader::LoadModelViewProjXUniform(vmath::mat4 matrix)
{
	UniformLoadMatrix(ModelViewProjXUniform, matrix);
}
void RainParticleSystemShaderLoader::LoadiFrameID_Uniform(GLuint iFrameID)
{
	UniformLoad1ui(iFrameID_Uniform, iFrameID);
}
void RainParticleSystemShaderLoader::LoadfTime_Uniform(GLfloat fTime)
{
	UniformLoad1f(fTime_Uniform, fTime);
}

void RainParticleSystemShaderLoader::LoadAlbedoTextureUniform(GLenum TEXTURE, GLuint tNo, GLuint textureID)
{
	UniformLoadTexture2D(Sampler2D_AlbedoTextureUniform, TEXTURE, tNo, textureID);
}

void RainParticleSystemShaderLoader::GetAllUniformLocations(void)
{
