...
CompositorSpaceShaderLoader::CompositorSpaceShaderLoader()
{
...
void CompositorSpaceShaderLoader::LoadSampler2D_FarClouds_Uniform(GLenum TEXTURE, GLuint tNo, GLuint textureID)
{
	UniformLoadTexture2D(Sampler2D_FarClouds_Uniform, TEXTURE, tNo, textureID);
}

void CompositorSpaceShaderLoader::LoadSampler2D_Clouds_Uniform(GLenum TEXTURE, GLuint tNo, GLuint textureID)
{
	UniformLoadTexture2D(Sampler2D_Clouds_Uniform, TEXTURE, tNo, textureID);
}

void CompositorSpaceShaderLoader::LoadSampler2D_Deffered_Uniform(GLenum TEXTURE, GLuint tNo, GLuint textureID)
{
	UniformLoadTexture2D(Sampler2D_Deffered_Uniform, TEXTURE, tNo, textureID);
}

void CompositorSpaceShaderLoader::LoadSampler2D_Background_Uniform(GLenum TEXTURE, GLuint tNo, GLuint textureID)
{
	UniformLoadTexture2D(Sampler2D_Background_Uniform, TEXTURE, tNo, textureID);
}

void CompositorSpaceShaderLoader::LoadSampler2D_Extra_Uniform(GLenum TEXTURE, GLuint tNo, GLuint textureID)
{
	UniformLoadTexture2D(Sampler2D_Extra_Uniform, TEXTURE, tNo, textureID);
}

void CompositorSpaceShaderLoader::LoadSampler2D_Flare_Uniform(GLenum TEXTURE, GLuint tNo, GLuint textureID)
{
	UniformLoadTexture2D(Sampler2D_Flare_Uniform, TEXTURE, tNo, textureID);
}

void CompositorSpaceShaderLoader::Loadv2InvResolution_Uniform(vmath::vec2 InvRes)
{
	UniformLoadVec2(v2InvResolution_Uniform, InvRes);
}

void CompositorSpaceShaderLoader::LoadfMixSpaceGround_Uniform(GLfloat factor)
{
	UniformLoad1f(fMixSpaceGround_Uniform, factor);
}


bool CompositorSpaceShaderLoader::Initialize(void)
{
...
void CompositorSpaceShaderLoader::GetAllUniformLocations(void)
{
	...
	fMixSpaceGround_Uniform = GetUniformLocation("fMixSpaceGround");
}
