...
class CloudGroundShaderLoader :	public ZzShaderLoader
{
public:
	CloudGroundShaderLoader(GLuint AtmoShader);
	~CloudGroundShaderLoader();
...
private:
	...
	//variables
	const GLchar* filepath_cs = "Resources/Shaders/Clouds/CloudsGround.Compute";
