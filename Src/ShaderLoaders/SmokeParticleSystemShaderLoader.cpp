...
SmokeParticleSystemShaderLoader::SmokeParticleSystemShaderLoader()
{
...
bool SmokeParticleSystemShaderLoader::Initialize(void)
{
...
void SmokeParticleSystemShaderLoader::LoadModelViewProjXUniform(vmath::mat4 matrix)
{
	UniformLoadMatrix(ModelViewProjXUniform, matrix);
}
void SmokeParticleSystemShaderLoader::LoadiFrameID_Uniform(GLuint iFrameID)
{
	UniformLoad1ui(iFrameID_Uniform, iFrameID);
}
void SmokeParticleSystemShaderLoader::LoadfTime_Uniform(GLfloat fTime)
{
	UniformLoad1f(fTime_Uniform, fTime);
}

void SmokeParticleSystemShaderLoader::LoadAlbedoTextureUniform(GLenum TEXTURE, GLuint tNo, GLuint textureID)
{
	UniformLoadTexture2D(Sampler2D_AlbedoTextureUniform, TEXTURE, tNo, textureID);
}

void SmokeParticleSystemShaderLoader::GetAllUniformLocations(void)
{
