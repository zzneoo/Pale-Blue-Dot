...
class TemporalPassShaderLoader : public ZzShaderLoader
{
public:
	TemporalPassShaderLoader();
	~TemporalPassShaderLoader();
	...
	void LoadSampler2DCurrFrameExtra_Uniform(GLenum TEXTURE, GLuint tNo, GLuint textureID);
	void LoadSampler2DPrevFrameExtra_Uniform(GLenum TEXTURE, GLuint tNo, GLuint textureID);
...
private:
	...
	//Class Members
	const GLchar* filepath_vs = "Resources/Shaders/TemporalUpscale/TemporalUpscale.vs";
	const GLchar* filepath_fs = "Resources/Shaders/TemporalUpscale/TemporalUpscale.fs";

	//Uniform Locations
	GLuint Sampler2DCurrFrameNearest_Uniform;
	GLuint Sampler2DCurrFrameLinear_Uniform;
	GLuint Sampler2DPrevFrame_Uniform;
	GLuint Sampler2DPrevFrameExtra_Uniform;
	GLuint Sampler2DCurrVelocity_Uniform;
	GLuint Sampler2DCurrFrameExtra_Uniform;
